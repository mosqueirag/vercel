...
export default async function AdminLogin({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <main className={styles.access}>
    <section className={styles.accessIntro}><Link className={styles.accessBrand} href="/">COOPSAR</Link><div><p className={styles.eyebrow}>Centro de Gestión</p><h2>Gestión simple de servicios, contenidos y atención.</h2><p>Una herramienta interna para acompañar el trabajo diario de COOPSAR.</p></div></section>
