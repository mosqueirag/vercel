...
const panels: Partial<Record<AssistantIntent, Panel>> = {
  ...
  pay_invoice: { eyebrow: "Facturas y pagos", title: "Resolvé tu factura desde los accesos oficiales", description: "Te llevamos directamente a la Oficina Virtual y a la información de medios de pago.", links: [{ label: "Oficina Virtual", href: "https://www.cooponlineweb.com.ar/SARMIENTO/Login", detail: "Consultá deuda, facturas y pagos.", icon: "$" }, { label: "Medios de pago", href: "/medios-de-pago", detail: "Revisá las alternativas disponibles.", icon: "$" }] },
};
