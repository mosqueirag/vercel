...
export const homeAdaptivePanels: Partial<Record<AssistantIntent, Panel>> = {
  internet_signup: { eyebrow: "Internet", title: "Encontrá la mejor opción para tu conexión", description: "Consultá cobertura, conocé las alternativas y avanzá cuando encuentres la opción adecuada.", links: [{ label: "Consultar cobertura", href: "/internet#contratar", detail: "Verificá el servicio disponible en tu domicilio.", icon: "⌁" }, { label: "Conocer Internet", href: "/internet", detail: "Revisá las alternativas confirmadas.", icon: "◌" }] },
  fiber_signup: { eyebrow: "Tu recorrido de Internet", title: "Avanzá con tu conexión por fibra", description: "Primero confirmamos la cobertura y las alternativas disponibles para tu domicilio.", links: [{ label: "Consultar cobertura", href: "/internet#contratar", detail: "Verificá el servicio disponible en tu domicilio.", icon: "⌁" }, { label: "Conocer Internet", href: "/internet", detail: "Revisá tecnología y condiciones confirmadas.", icon: "◌" }, { label: "Solicitar validación", href: "/internet#contratar", detail: "Continuá cuando la cobertura esté confirmada.", icon: "+" }] },
  ...
  energy_problem: { eyebrow: "Asistencia de energía", title: "Revisá el estado del servicio", description: "Mostramos únicamente información operativa y canales oficiales confirmados por COOPSAR.", links: [{ label: "Estado de energía", href: "/#estado", detail: "Verificá el estado publicado.", icon: "⚡" }, { label: "Cortes programados", href: "/cortes-programados", detail: "Consultá avisos vigentes.", icon: "◌" }, { label: "Informar un problema", href: "/energia", detail: "Accedé a los canales oficiales disponibles.", icon: "!" }] },
};
