...
const panels: Partial<Record<AssistantIntent, Panel>> = {
  fiber_signup: { eyebrow: "Tu recorrido de Internet", title: "Avanzá directamente hacia la instalación", description: "Priorizamos cobertura, información del servicio y contacto comercial para que no tengas que recorrer el sitio.", links: [{ label: "Consultar cobertura", href: "/internet#contratar", detail: "Verificá el servicio disponible en tu domicilio." }, { label: "Conocer Internet", href: "/internet", detail: "Revisá tecnología y condiciones confirmadas." }, { label: "Solicitar instalación", href: "/internet#contratar", detail: "Continuá con la solicitud comercial." }] },
  fiber_coverage: { eyebrow: "Cobertura", title: "Encontrá el servicio disponible en tu domicilio", description: "La consulta usa el padrón existente y mantiene la validación técnica como instancia final.", links: [{ label: "Consultar domicilio", href: "/internet#contratar", detail: "Ingresá calle y altura." }, { label: "Ver Internet", href: "/internet", detail: "Conocé la tecnología disponible." }] },
