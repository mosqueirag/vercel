...
export function CoopOnlinePromo() {
  return <section className="coop-online-promo section" aria-labelledby="coop-online-title">
    <div className="coop-online-promo-copy">
      ...
      <h2 id="coop-online-title">Gestioná tus servicios desde el celular.</h2>
      <p>Accedé al canal digital de COOPSAR desde tu dispositivo Android.</p>
      <CoopOnlineDownloadLink className="coop-online-promo-cta" source="home_app_promo">Disponible en Google Play <span aria-hidden="true">→</span></CoopOnlineDownloadLink>
    </div>
