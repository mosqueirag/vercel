...
export function InternetCenter({ variant = "home" }: { variant?: "home" | "page" }) {
  ...
  useEffect(() => {
    const onPlanSelection = (event: Event) => {
      ...
      setSelectedInterest({ id: detail.planId, slug: detail.planSlug, name: detail.planName || "Plan de Internet", speedDownMbps: detail.speedDownMbps ?? null, speedUpMbps: detail.speedUpMbps ?? null, priceAmount: detail.priceAmount ?? null, currency: detail.currency ?? null });
      setSelected(null);
      setCoverage(null);
      setResult(null);
      setError("");
