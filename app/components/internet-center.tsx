...
type CoverageResult = { coverageStatus: "available" | "nearby" | "planned" | "unavailable" | "unknown"; technology: string | null; commercialAvailability: boolean; plans: Plan[]; nextAction: "show_plans" | "coverage_validation" | "fiber_waitlist"; message: string };
