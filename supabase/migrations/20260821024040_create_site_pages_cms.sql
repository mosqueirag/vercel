-- Reconstructed from the applied coopsar-staging migration history on 2026-08-21.
-- This is the canonical initial CMS schema. The subsequent data migration seeds
-- the current service-page content while preserving every row as a draft.
