...
select lives_ok($$ select public.create_internet_request_v2_with_outbox('NET-2026-DDDDDDDD','JRN-2026-ABCDEF12','SES-ABCDEF1234567890','fiber_waitlist','hogar','Persona Test','2974000000',null,'TEST',500,'', 'unknown', null, null, true, false, 'test', repeat('e',64)) $$, 'server atomically creates a fiber waitlist and its outbox event');
