...
export type Procedure = {
  id: "ownership_change" | "new_supply" | "digital_invoice" | "payments" | "update_data" | "phone_service" | "funeral_service" | "funeral_family_update" | "human_handoff";
  title: string;
  description: string;
  icon: string;
...
export const procedures: readonly Procedure[] = [
  ...
  { id: "update_data", title: "Actualizar datos", description: "Ingresá al canal oficial para gestionar tu información.", icon: "✎", intent: "office_virtual", service: "billing", resolutionType: "official_link" },
