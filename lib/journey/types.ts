...
export const journeyEventTypes = [
  ...
  "fiber_coverage_checked", "fiber_lead_started", "fiber_lead_created", "internet_audience_selected", "enterprise_internet_interest", "enterprise_whatsapp_click",
  "fiber_coverage_check", "fiber_coverage_result", "internet_plans_viewed", "internet_plan_recommended", "plan_view", "plan_selected", "lead_started", "lead_created", "lead_failed", "fiber_waitlist_started", "fiber_waitlist_created",
  ...
  "navigation_executed", "contextual_component_rendered", "action_clicked", "quick_access_click", "procedure_selected", "app_download_click", "home_priority_applied", "form_started", "form_completed", "help_article_view",
