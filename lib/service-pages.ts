...
export const servicePages: Record<string, ServicePageContent> = {
  ...
  internet: { eyebrow: "Conectividad", title: "Internet para cada necesidad", intro: "Planes, soporte y solicitudes de cobertura con atención local.", items: [["Contratar internet", "Usá el recomendador y solicitá contacto.", "/internet#contratar"], ["Consultar cobertura", "La disponibilidad requiere evaluación técnica.", "/internet#contratar"], ["Soporte", `Comunicaciones: ${CONTACT.internetSupport}.`, `tel:+542974641110`], ["Tecnología disponible", "Consultá cobertura para conocer la alternativa en tu domicilio.", "/internet#contratar"]] },
  "fibra-optica": { eyebrow: "Internet", title: "Conectividad de nueva generación", intro: "Consultá disponibilidad de Internet para tu hogar, comercio o empresa.", items: [["Cobertura", "Pendiente de evaluación técnica por zona.", "/internet#contratar"], ["Planes", "Velocidades y precios pendientes de confirmación.", "/internet#contratar"], ["Solicitud", "Registrá tus datos para recibir asesoramiento.", "/internet#contratar"], ["Soporte", `Canal técnico: ${CONTACT.internetSupport}.`, `tel:+542974641110`]] },
