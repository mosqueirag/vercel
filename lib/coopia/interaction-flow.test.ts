...
import { coopiaActiveContext, coopiaInitialNeeds, coopiaJourneyLabel, coopiaLoadingCopy, coopiaStepActions } from "./interaction-flow";
...
describe("COOPIA guided interaction", () => {
  ...
  it("uses a single service context for an active step", () => expect(coopiaActiveContext({ service: "billing", ui: { type: "payment", data: {} } } as never)).toBe("Facturas y pagos"));
