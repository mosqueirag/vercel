...
const rules: readonly Rule[] = [
  ...
  { id: "internet_issue", service: "internet", analyticsKey: "internet_issue", suggestedActions: ["START_DIAGNOSIS", "OPEN_COMPLAINT_WHATSAPP"], confidence: 0.96, patterns: [/\b(no (tengo|anda|funciona)|sin|problema|falla|cort[óo])\b.*\b(internet|fibra|ftth)\b/i, /\b(internet|fibra|ftth)\b.*\b(no (anda|funciona)|sin|problema|falla|cort[óo])\b/i] },
  ...
  { id: "fiber_interest", service: "fiber", analyticsKey: "fiber_interest", suggestedActions: ["CHECK_COVERAGE", "SHOW_INTERNET_PLANS", "REQUEST_INSTALLATION"], confidence: 0.95, patterns: [/\b(quiero|contratar|solicitar|instalar|necesito)\b.*\b(fibra|ftth)\b/i, /\b(fibra|ftth)\b.*\b(quiero|contratar|solicitar|instalar)\b/i] },
  { id: "internet_interest", service: "internet", analyticsKey: "internet_interest", suggestedActions: ["CHECK_COVERAGE", "SHOW_INTERNET_PLANS", "REQUEST_INSTALLATION"], confidence: 0.95, patterns: [/\b(quiero|contratar|solicitar|instalar|necesito)\b.*\binternet\b/i, /\binternet\b.*\b(quiero|contratar|solicitar|instalar|necesito)\b/i] },
