...
const rules: Rule[] = [
  ...
  { intent: "internet_problem", service: "fiber", suggestedAction: "route_complaint", patterns: [/\b(no (tengo|anda|funciona)|sin|problema|falla|cort[óo])\b.*\b(fibra|ftth)\b/i, /\b(fibra|ftth)\b.*\b(no (anda|funciona)|sin|problema|falla|cort[óo])\b/i], confidence: 0.95 },
  { intent: "internet_problem", service: "internet", suggestedAction: "route_complaint", patterns: [/\b(no (tengo|anda|funciona)|sin|problema|falla|cort[óo])\b.*\binternet\b/i, /\binternet\b.*\b(no (anda|funciona)|sin|problema|falla|cort[óo])\b/i], confidence: 0.95 },
