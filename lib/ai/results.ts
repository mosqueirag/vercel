...
export const assistantActions = [
  "CHECK_COVERAGE", "SHOW_INTERNET_PLANS", "SELECT_INTERNET_PLAN", "START_FIBER_WAITLIST", "REQUEST_INSTALLATION", "REQUEST_COVERAGE_VALIDATION", "SHOW_SERVICE_STATUS", "START_DIAGNOSIS",
